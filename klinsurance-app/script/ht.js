var ht = (function ($) {
    "use strict";
    var ip = {}; // 服务地址
    //ip.inscrmservice="http://192.168.0.199:8020/inscrm-service";
    ip.ilcomimg = "http://192.168.0.202:9292/upload/inscrm-app";
    ...
    constants.isFirstCust = "isFirstCust"; //是否第一次进入客户列表
